  ...
  return (
    <div className="relative bg-gray-900 text-white overflow-hidden">
      ...
      <div 
        ...
        role="img"
        aria-label="Спецтехника в работе - манипулятор и экскаватор в Томске"
      ></div>
      ...
      <div className="container mx-auto px-4 py-12 md:py-28 relative z-10">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-3xl md:text-5xl font-bold mb-4 leading-tight lg:text-6xl text-center">
            Аренда спецтехники в Томске за 1 клик!
          </h1>
          <h2 className="text-xl md:text-2xl mb-6 text-center text-secondary">
            Манипуляторы, экскаваторы, погрузчики 24/7 — сэкономьте до 40% на грузоперевозках и работах под ключ
          </h2>
          ...
          <p className="text-lg md:text-xl mb-6 text-center">
            Не ждите свободных машин в Томске и области — бронируйте технику онлайн!
          </p>
